...
In the root of this repository is a YAML file with the correct config to instantiate an Anaconda envrionment with all of the necesary packages. Create an Anaconda environment with it using the following command in an Anaconda powershell window:
